...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference("Fund.count") do
      post funds_url, params: { fund: { allocated: @fund.allocated, name: @fund.name, target: @fund.target, target_date: @fund.target_date } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { allocated: @fund.allocated, name: @fund.name, target: @fund.target, target_date: @fund.target_date } }
